-- 既存のプロフィールを更新します。
-- '2287c81e-b416-4657-be22-c720310364dc'の部分はご自身のユーザーIDにしてください。
UPDATE public.profiles
SET
  username = 'creator_a',
  bio = 'アーティストです。よろしくお願いします！',
  website_url = 'https://example.com'
WHERE id = '2287c81e-b416-4657-be22-c720310364dc';

-- TRUNCATEを使ってテーブルのデータを削除し、IDの連番をリセットします。
TRUNCATE public.categories, public.tags, public.products, public.product_tags RESTART IDENTITY CASCADE;
...
('夜明けの海', '静かな夜明けの海の情景を描いた油絵です。高解像度のデジタルデータでお届けします。', 25000, 'https://placehold.jp/300x300.png', 'https://example.com/file.jpg', '2287c81e-b416-4657-be22-c720310364dc', 1, '個人利用ライセンス', '個人の鑑賞目的でのみ利用可能です。商用利用、再配布は禁止です。'),
